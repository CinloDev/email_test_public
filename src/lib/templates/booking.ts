...
<head>
  <meta charset="utf-8">
  <style>
    body { margin: 0; padding: 0; background-color: #DFF1F1; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; min-height: 100%; }
...
<body>
  <div style="background:#DFF1F1; min-height:100vh; padding: 20px 0;">
    <div class="container">
      <div class="hero"></div>
      <div class="content">
